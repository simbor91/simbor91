...
<!--
**simbor91/simbor91** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- 🛫 Building my **Typescript** travel blog using AI tool (Goolge Stitch, AI Studio, GitHub Actions).
...
- **Languages:** Python (self-learning), C, C++, Java (academic).
- **Tools:** Linux (Mint), Git, Jira, Vector CANoe, Confluence.
- **Testing & Quality:** ISTQB® Certified Foundation Level, Requirement Analysis, Root Cause Analysis.

### 🏡 Remote Work Philosophy
I am a strong advocate for **autonomy** and **asynchronous communication**.
My experience in distributed teams has taught me that clear documentation and individual accountability are the keys to success, regardless of geography.
